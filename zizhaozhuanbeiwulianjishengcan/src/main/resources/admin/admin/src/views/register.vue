    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">制造装备物联及生产管理ERP系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="维修员姓名" class="input" v-if="tableName=='weixiuyuan'">
                            <el-input v-model="ruleForm.weixiuyuanName" autocomplete="off" placeholder="维修员姓名"  />
                        </el-form-item>
                        <el-form-item label="维修员手机号" class="input" v-if="tableName=='weixiuyuan'">
                            <el-input v-model="ruleForm.weixiuyuanPhone" autocomplete="off" placeholder="维修员手机号"  />
                        </el-form-item>
                        <el-form-item label="维修员身份证号" class="input" v-if="tableName=='weixiuyuan'">
                            <el-input v-model="ruleForm.weixiuyuanIdNumber" autocomplete="off" placeholder="维修员身份证号"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='weixiuyuan'">
                            <el-input v-model="ruleForm.weixiuyuanEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
                        <el-form-item label="员工姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="员工姓名"  />
                        </el-form-item>
                        <el-form-item label="员工手机号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuPhone" autocomplete="off" placeholder="员工手机号"  />
                        </el-form-item>
                        <el-form-item label="员工身份证号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="员工身份证号"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.weixiuyuanIdNumber)&& 'weixiuyuan'==this.tableName){
                                this.$message.error('维修员身份证号不能为空');
                                return
                            }
