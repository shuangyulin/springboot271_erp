  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='weixiuyuan'" label='头像' prop="weixiuyuanPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修员手机号' prop="weixiuyuanPhone">
               <el-input v-model="ruleForm.weixiuyuanPhone"  placeholder='维修员手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='维修员身份证号' prop="weixiuyuanIdNumber">
               <el-input v-model="ruleForm.weixiuyuanIdNumber"  placeholder='维修员身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='weixiuyuan'"  label='邮箱' prop="weixiuyuanEmail">
               <el-input v-model="ruleForm.weixiuyuanEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='职能' prop="yonghuZhineng">
               <el-input v-model="ruleForm.yonghuZhineng"  placeholder='职能' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='部门' prop="bumenTypes">
                 <el-select v-model="ruleForm.bumenTypes" placeholder='请选择部门'>
                     <el-option
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.weixiuyuanPhoto)&& 'weixiuyuan'==this.flag){
                             ...
                             if( 'weixiuyuan' ==this.flag && this.ruleForm.weixiuyuanPhone&&(!isMobile(this.ruleForm.weixiuyuanPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.weixiuyuanIdNumber)&& 'weixiuyuan'==this.flag){
                             this.$message.error('维修员身份证号不能为空');
                             return
                         }

                             if( 'weixiuyuan' ==this.flag && this.ruleForm.weixiuyuanEmail&&(!isEmail(this.ruleForm.weixiuyuanEmail))){
                         ...
                         if((!this.ruleForm.yonghuZhineng)&& 'yonghu'==this.flag){
                             this.$message.error('职能不能为空');
                             return
                         }
