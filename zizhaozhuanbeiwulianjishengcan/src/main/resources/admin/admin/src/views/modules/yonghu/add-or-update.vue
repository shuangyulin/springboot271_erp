    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="员工姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="员工手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="员工手机号" prop="yonghuPhone">
                           <el-input v-model="ruleForm.yonghuPhone"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="员工身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="员工身份证号" prop="yonghuIdNumber">
                           <el-input v-model="ruleForm.yonghuIdNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="职能" prop="yonghuZhineng">
                       <el-input v-model="ruleForm.yonghuZhineng"
                                 placeholder="职能" clearable  :readonly="ro.yonghuZhineng"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="职能" prop="yonghuZhineng">
                           <el-input v-model="ruleForm.yonghuZhineng"
                                     placeholder="职能" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="入职日期" prop="yonghuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yonghuTime"
                                type="datetime"
                                placeholder="入职日期"
                                :disabled="ro.yonghuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuTime" label="入职日期" prop="yonghuTime">
                            <span v-html="ruleForm.yonghuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
